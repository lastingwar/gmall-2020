...
import com.lastingwar.uploader.LogUploader;
import com.lastingwar.utils.RanOpt;
import com.lastingwar.utils.RandomDate;
import com.lastingwar.utils.RandomNum;
import com.lastingwar.utils.RandomOptionGroup;
...
public class JsonMocker {
    ...
    private RanOpt[] eventOpts = {new RanOpt("addFavor", 10),
